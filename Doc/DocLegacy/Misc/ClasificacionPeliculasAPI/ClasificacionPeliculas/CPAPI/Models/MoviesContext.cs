...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySQL("server=127.0.0.1;userid=user;password=password;database=movies;TreatTinyAsBoolean=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<City>(entity =>
        {
            ...
            entity.Property(e => e.GeonameidRegion)
                .HasColumnType("bigint(20)")
                .HasColumnName("geonameidRegion");
        ...
        modelBuilder.Entity<PersonalInformation>(entity =>
        {
            ...
            entity.Property(e => e.Email)
                .HasMaxLength(255)
                .HasColumnName("email");
            entity.Property(e => e.GeonameidCity)
                .HasColumnType("bigint(20)")
                .HasColumnName("geonameidCity");
            entity.Property(e => e.Name)
                .HasMaxLength(255)
                .HasColumnName("name");
        ...
        modelBuilder.Entity<Region>(entity =>
        {
            ...
            entity.Property(e => e.Geonameid)
                .HasColumnType("bigint(20)")
                .HasColumnName("geonameid");
            entity.Property(e => e.GeonameidCountry)
                .HasColumnType("bigint(20)")
                .HasColumnName("geonameidCountry");
            entity.Property(e => e.Latitude)
                .HasPrecision(15, 8)
                .HasColumnName("latitude");
            entity.Property(e => e.Longitude)
